...
def calculate(info, team_header):
    ...
    if len(row_hlist) == 1 and len(row_alist) == 1:
        ...
        datas = [new_hpr, new_apr, new_hxg, new_axg, new_hprxg, new_aprxg, fix_num[2], fix_num[2], fix_num[2], fix_num[2],
        ...
        xg_changing = (((float(info[10])-float(info[11])) -
                       (fix_num[2]-float(row_alist[-1][9])))-fix_num[0])*fix_num[1]
        ...
        prxg_changing = (((int(info[8])-int(info[9]))-(float(info[10])-float(
            info[11]))-(fix_num[2]-float(row_alist[-1][9])))-fix_num[0])*fix_num[1]
        ...
        pr_changing = ((int(info[8])-int(info[9]))-(float(row_hlist[-1]
                       [9])-float(row_alist[-1][9]))-fix_num[0])*fix_num[1]
        xg_changing = ((float(info[10])-float(info[11]))-(
