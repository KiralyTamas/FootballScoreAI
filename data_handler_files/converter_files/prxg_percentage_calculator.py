...
def prxg_percentage_calculate(header,main_result):
    ...
    calculated_list=[]
    id_list=[]
    if os.path.exists(os.path.abspath("converted_csv_datas\main_result")+"\\main_prxg_result.csv") == False:
        open((os.path.abspath("converted_csv_datas\main_result")+"\\main_prxg_result.csv"), "x")
